...
django-configurator. The most common pattern is to have a base class
...
Every ``dj_configurator.Configuration`` subclass will automatically
...
tell that django-configurator by using the ``pristinemethod``
decorator, e.g.
...
.. versionchanged:: 0.4
    ...
    :class:`~dj_configurator.values.Value` classes and allow an
