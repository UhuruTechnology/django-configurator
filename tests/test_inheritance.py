...
class InheritanceTests(TestCase):
    ...
    def test_inherited(self):
        ...
        self.assertEqual(single_inheritance.ALLOWED_HOSTS, ["test"])
    ...
    def test_inherited2(self):
        ...
        self.assertEqual(multiple_inheritance.ALLOWED_HOSTS, ["test", "test-test"])
    ...
    def test_inherited3(self):
        ...
        self.assertEqual(mixin_inheritance.ALLOWED_HOSTS, ["test1", "test2", "test3"])
