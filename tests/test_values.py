...
from dj_configurator.values import (
    Value,
    BooleanValue,
    IntegerValue,
    FloatValue,
...
class ValueTests(TestCase):
    ...
    def test_env_var(self):
        ...
        self.assertEqual(
            value.to_python(os.environ["DJANGO_TEST"]), value.setup("TEST")
        )
    ...
    def test_list_values_separator(self):
        ...
        with env(DJANGO_TEST="/usr/bin:/usr/sbin:/usr/local/bin"):
            self.assertEqual(
                value.setup("TEST"), ["/usr/bin", "/usr/sbin", "/usr/local/bin"]
            )
    ...
    def test_secret_value(self):
        ...
        value = SecretValue(
            environ_name="FACEBOOK_API_SECRET", environ_prefix=None, late_binding=True
        )
        self.assertRaises(ValueError, value.setup, "TEST")
    ...
    def test_database_url_additional_args(self):
        ...
        with patch(
            "dj_configurator.values.DatabaseURLValue.caster", mock_database_url_caster
        ):
    ...
    def test_cache_url_value(self):
        cache_setting = {
            "default": {
                ...
                if DJANGO_VERSION < (4,)
                else "django.core.cache.backends.redis.RedisCache",  # noqa: E501
    ...
    def test_setup_value(self):
        ...
        with env(EMAIL_URL="smtps://user@domain.com:password@smtp.example.com:587"):  # noqa: E501
            ...
            self.assertEqual(
                Target.EMAIL_BACKEND, "django.core.mail.backends.smtp.EmailBackend"
            )
